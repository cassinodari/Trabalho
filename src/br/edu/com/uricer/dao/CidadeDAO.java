 ...
 * Concentra as operacoes pra uma persistencia das instancias de classes de entidades.
 * @author Cassi
 */
public interface CidadeDAO {
     ...
     * será utilizado para operaçoes de insercao e alteracao de dados do objeto.
     * se o ID do objeto está null, fará uma inclusão, caso hover id, fará uma alteração
     * @param objeto objeto Instância do objeto a ser inserido
     * @return Instancia atualizada do objeto após sincronizado com o banco de dados
    ...
    /**
     * Busca todas as cidades cadastradas no banco de dados ordenada por algum campo
     * @param ordem
     * @return retora lista de cidades
     */
    ...
    /**
     * Deleta uma instanicia do banco de dados de um determinado objeto com base no id informado
